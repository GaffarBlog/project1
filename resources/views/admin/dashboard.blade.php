                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="{{ asset('assets/img/user3-128x128.jpg') }}" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Nadia Jolie
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="{{ asset('assets/img/user5-128x128.jpg') }}" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Nora S. Vans
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="{{ asset('assets/img/user6-128x128.jpg') }}" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            John K.
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="{{ asset('assets/img/user8-128x128.jpg') }}" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Kenneth M.
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <div class="row text-center m-1">
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle" src="{{ asset('assets/img/user1-128x128.jpg') }}" alt="User Image" />
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle" src="{{ asset('assets/img/user7-128x128.jpg') }}" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                Jane
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle" src="{{ asset('assets/img/user6-128x128.jpg') }}" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                John
                                            </a>
                                            <div class="fs-8">12 Jan</div>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle" src="{{ asset('assets/img/user2-160x160.jpg') }}" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                Alexander
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle" src="{{ asset('assets/img/user5-128x128.jpg') }}" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                Sarah
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle" src="{{ asset('assets/img/user4-128x128.jpg') }}" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                Nora
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle" src="{{ asset('assets/img/user3-128x128.jpg') }}" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                                Nadia
                                            </a>
                                            <div class="fs-8">15 Jan</div>
                        ...
                        <div class="card-body p-0">
                            <div class="px-2">
                                <div class="d-flex border-top py-2 px-1">
                                    <div class="col-2">
                                        <img src="{{ asset('assets/img/default-150x150.png') }}" alt="Product Image" class="img-size-50" />
                                    </div>
                                    <div class="col-10">
